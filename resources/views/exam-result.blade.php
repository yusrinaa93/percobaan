...
<div class="dashboard-container">
 ...
 <section class="content-section">
            <h2>HASIL UJIAN</h2>
            <div class="content-card exam-card" style="text-align: center;">
                
                {{-- Controller mengirim $result --}}
                <h3>Ujian: {{ $result->exam->title }}</h3>
                <p>Terima kasih telah menyelesaikan ujian.</p>
                
                <h4 style="margin-top: 20px;">Nilai Anda:</h4>
                <h1 style="font-size: 5rem; color: #4CAF50; margin: 10px 0;">
                    {{ $result->score }}
                </h1>
